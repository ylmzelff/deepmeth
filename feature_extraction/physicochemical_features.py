...
if __name__ == "__main__":
    ...
    # Example 501 bp sequence containing a central CpG.
    test_sequence = (
        "A" * 250
        + "CG"
        + "T" * 249
    ...
    print(
        ...
        len(physicochemical_table),
    )

    print(
        "Physicochemical feature shape:",
        test_features.shape,
    )

    print(
        "Physicochemical feature dtype:",
        test_features.dtype,
    )

    print("\nDictionary keys:")
    print(sorted(physicochemical_table.keys()))

    print("\nDinucleotides around the central CpG:")
    print("Position 249:", test_sequence[249:251])
    print("Position 250:", test_sequence[250:252])
    print("Position 251:", test_sequence[251:253])

    print("\nFeature vector at position 249 (AC):")
    print(test_features[0, :, 249])

    print("\nFeature vector at position 250 (CG):")
    print(test_features[0, :, 250])

    print("\nFeature vector at position 251 (GT):")
    print(test_features[0, :, 251])

    assert np.allclose(
        test_features[0, :, 249],
        physicochemical_table["AC"],
    )

    assert np.allclose(
        test_features[0, :, 250],
        physicochemical_table["CG"],
    )

    assert np.allclose(
        test_features[0, :, 251],
        physicochemical_table["GT"],
    )

    print("\nAll physicochemical mapping tests passed.")